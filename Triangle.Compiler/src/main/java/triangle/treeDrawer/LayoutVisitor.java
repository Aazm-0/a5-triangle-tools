...
public class LayoutVisitor implements ActualParameterVisitor<Void, DrawingTree>,
    ...
    @Override
    public DrawingTree visitPostFixCommand(PostFixCommand ast, Void unused) {
        // Drawing pattern for the post fix operator which makes use of already defined drawing patterns
        // Only adds PostFix new drawing implementation
        var d1 = ast.v.visit(this);
        var d2 = ast.postfixOp.visit(this);
